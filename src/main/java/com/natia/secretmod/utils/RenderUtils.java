...
public class RenderUtils {
     ...
     * @author Moulberry
     */
    public static void drawHoveringText(java.util.List<String> textLines, final int mouseX, final int mouseY, final int screenWidth, final int screenHeight, final int maxTextWidth, FontRenderer font) {
        if (!textLines.isEmpty()) {
            ...
            if (needsWrap) {
                ...
                java.util.List<String> wrappedTextLines = new ArrayList<String>();
