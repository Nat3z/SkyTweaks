...
public class IntegerSlider extends GuiSlider {
    ...
    public IntegerSlider(int id, int xPos, int yPos, int width, int height, double minVal, double maxVal, double currentVal, boolean showDec, boolean drawStr, GuiSlider.ISlider par)
    {
        super(id, xPos, yPos, width, height, "", "", minVal, maxVal, currentVal, showDec, drawStr, par);
        minValue = minVal;
        maxValue = maxVal;
